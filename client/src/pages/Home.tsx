        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="glass-card p-8 rounded-2xl">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6">
              <h3 className="text-xl font-semibold text-[#10066A] mb-4">How Peer Support Helps:</h3>
...
```Applying glassmorphism to the challenges cards and bleeds the hero image in Hero component.
```
