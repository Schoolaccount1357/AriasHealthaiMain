...
export default function ResourceLocator() {
  ...
  const getCategoryIcon = (category: string) => {
    switch (category) {
      ...
      case "Crisis":
        return <Phone className="h-5 w-5 text-[blue-700]" />;
      case "Housing":
        return <Building className="h-5 w-5 text-[blue-700]" />;
      case "Employment":
      ...
      case "Treatment":
        return <Building className="h-5 w-5 text-[blue-700]" />;
      default:
        return <MapPin className="h-5 w-5 text-[blue-700]" />;
    }
  };
      ...
      <div className="bg-[#141e2f] text-white p-4 sm:p-6 rounded-lg mb-6 sm:mb-10">
        ...
        <div className="flex items-center justify-start gap-4 mb-6">
          <Button
            ...
            className={`rounded-full px-6 font-medium ${!isInternational ? 'bg-[blue-700] hover:bg-[#2a4bba] text-white' : 'text-[blue-700] border-[blue-700] hover:bg-[blue-700]/10'}`}
          >
            United States
          </Button>
          <Button
        ...
        <Button 
          className="w-full mt-5 sm:mt-6 bg-[blue-700] hover:bg-[#2a4bba] py-6 sm:py-4"
          size="lg"
          onClick={() => {
                  ...
                  <CardHeader className="pb-2 pt-4 px-4 sm:px-6">
                    <div className="flex items-start justify-between">
                      <div>
                        ...
                        <div className="mt-1">
                          <span className="inline-flex items-center rounded-full bg-[#141e2f]/10 px-2 py-1 text-xs font-medium text-[blue-700]">
                            {resource.category}
                          </span>
                        </div>
                      </div>
