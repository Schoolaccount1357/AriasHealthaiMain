...
export function Hero() {
  ...
  return (
    <section className="relative w-screen -mx-4 sm:-mx-6 lg:-mx-8 xl:-mx-[calc((100vw-1280px)/2)] mb-8 sm:mb-12 lg:mb-16">
      ...
      <div className="bg-gradient-to-r from-gray-800 to-gray-900 border-t border-gray-700 px-4 sm:px-6 py-4 sm:py-4">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between sm:gap-4">
            ...
            <div className="flex flex-col gap-2 sm:flex-row sm:gap-2 text-xs">
              <Button 
                ...
                size="sm"
                className="bg-[#3e64dd]/90 hover:bg-[#3e64dd] text-white text-xs px-4 py-3 sm:py-2 h-auto rounded-full min-h-[44px] sm:min-h-auto"
              >
              ...
              <div className="flex gap-2">
                <Button 
                  ...
                  size="sm"
                  className="bg-[#3e64dd]/70 hover:bg-[#3e64dd]/90 text-white text-xs px-4 py-3 sm:py-2 h-auto rounded-full flex-1 sm:flex-initial min-h-[44px] sm:min-h-auto"
                >
                  Text 838255
                </Button>
                <Button 
