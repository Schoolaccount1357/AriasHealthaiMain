...
import HeroImage from "@assets/AdobeStock_1106608464_1753746485646.jpeg";
    ...
    <section className="relative w-screen h-[85vh] sm:h-[80vh] md:h-[84vh] -ml-4 sm:-ml-6 lg:-ml-8 xl:-ml-[calc((100vw-1280px)/2)] -mr-4 sm:-mr-6 lg:-mr-8 xl:-mr-[calc((100vw-1280px)/2)] -mt-16 sm:-mt-20 mb-0">
      ...
      <div className="relative w-full h-full overflow-hidden">
        ...
        <img
          ...
          style={{ objectPosition: 'center center', transform: 'scale(1.04) scaleX(-1)' }}
        />
        
        {/* Brightened Dark Overlay - 40% lighter than original */}
        <div className="absolute inset-0 bg-gradient-to-r from-black/42 via-black/30 to-black/24 hero-overlay"></div>
        ...
        <div className="absolute inset-0 flex items-center justify-center lg:items-end lg:justify-start pt-20 sm:pt-16 pb-24 sm:pb-28 lg:pb-20 xl:pb-24">
          <div className="max-w-md sm:max-w-lg lg:max-w-xl ml-0 lg:ml-8 xl:ml-12 text-center lg:text-left text-white px-3 sm:px-6 lg:px-8 w-full">
            {/* Compact Text Container - Wider to match design */}
            <div className="backdrop-blur-sm bg-black/35 rounded-xl p-3 sm:p-4 md:p-5 shadow-xl mx-2 sm:mx-0 max-w-lg">
              ...
              <Button 
                ...
                size="default"
                className="backdrop-blur-md bg-green-400/20 hover:bg-green-500/30 text-white px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-bold rounded-lg shadow-xl hover:shadow-2xl transition-all duration-300 w-full sm:w-auto min-h-[48px] sm:min-h-[52px] border border-white/10 hover:border-white/20"
                aria-label="Get early access to Willow - Navigate to enrollment form"
                style={{
                  textShadow: '1px 1px 2px rgba(0,0,0,0.8)',
                  boxShadow: '0 0 15px rgba(74, 222, 128, 0.2), 0 0 30px rgba(74, 222, 128, 0.1), inset 0 1px 0 rgba(255,255,255,0.2)'
                }}
              >
