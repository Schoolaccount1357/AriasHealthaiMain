    ...
    <section className="mb-12">
        ...
        <div className="md:flex relative">
          <div className="md:w-1/2 p-6 sm:p-8 md:p-12 flex flex-col justify-center z-10">
            ...
            <div className="space-y-3 md:space-y-4">
              <Button 
                asChild
                className="bg-[#3e64dd] text-white hover:bg-[#2a4bba] transition-colors w-full py-6 sm:py-4 sm:w-auto"
                size="lg"
              >
      ...
      <div className="mt-12 bg-gray-50 p-4 sm:p-8 rounded-lg">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
          <div className="relative flex flex-col items-center text-center p-4 sm:p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow">
            <div className="bg-[#141e2f] w-14 h-14 sm:w-16 sm:h-16 mx-auto mb-3 sm:mb-4 rounded-full flex items-center justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 sm:h-8 sm:w-8 text-[#3e64dd]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
              </svg>
            </div>
            <h3 className="text-lg sm:text-xl font-semibold mb-1 sm:mb-2 text-gray-800">Join the Waitlist</h3>
            <p className="text-sm sm:text-base text-gray-600">Fill out a simple form to reserve your spot.</p>
          ...
          <div className="relative flex flex-col items-center text-center p-4 sm:p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow">
            ...
            <h3 className="text-lg sm:text-xl font-semibold mb-1 sm:mb-2 text-gray-800">Get Matched</h3>
            <p className="text-sm sm:text-base text-gray-600">We'll connect you with peers who truly understand your journey.</p>
            {/* Right arrow for desktop */}
            <div className="hidden md:block absolute right-0 top-1/3 transform translate-x-1/2 z-10">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-[#3e64dd]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
          ...
          <div className="relative flex flex-col items-center text-center p-4 sm:p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow">
            ...
            <h3 className="text-lg sm:text-xl font-semibold mb-1 sm:mb-2 text-gray-800">Stay Connected</h3>
            <p className="text-sm sm:text-base text-gray-600">Spot early warning signs together and stay engaged.</p>
            {/* Right arrow for desktop */}
            <div className="hidden md:block absolute right-0 top-1/3 transform translate-x-1/2 z-10">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-[#3e64dd]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
          ...
          <div className="flex flex-col items-center text-center p-4 sm:p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow">
            ...
            <h3 className="text-lg sm:text-xl font-semibold mb-1 sm:mb-2 text-gray-800">Grow Stronger</h3>
            <p className="text-sm sm:text-base text-gray-600">Get real-time encouragement, stay supported, and build lasting recovery.</p>
          </div>
        </div>
      </div>
    </section>
