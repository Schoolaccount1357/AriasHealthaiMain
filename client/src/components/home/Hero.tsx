    ...
    <section className="mb-12">
      ...
      <div className="mt-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-[#1c2537] p-6 rounded-lg shadow-md text-center">
            ...
            <h3 className="text-xl font-semibold mb-2 text-white">Match</h3>
            <p className="text-gray-300">Find peers who understand you.</p>
          </div>
          ...
          <div className="bg-[#1c2537] p-6 rounded-lg shadow-md text-center">
            ...
            <h3 className="text-xl font-semibold mb-2 text-white">Detect</h3>
            <p className="text-gray-300">Spot early warning signs.</p>
          </div>
          ...
          <div className="bg-[#1c2537] p-6 rounded-lg shadow-md text-center">
            ...
            <p className="text-gray-300">Get real-time encouragement before crisis.</p>
          </div>
        </div>
      </div>
    </section>
