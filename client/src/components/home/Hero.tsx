  ...
  return (
    <section className="mb-12">
      ...
      <div className="mt-12 bg-gray-50 p-8 rounded-lg">
        <h2 className="text-2xl font-bold text-center mb-8">Your Journey with AriasHealth.ai</h2>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="relative flex flex-col items-center text-center p-6">
            ...
            <h3 className="text-xl font-semibold mb-2 text-gray-800">Join the Waitlist</h3>
            <p className="text-gray-600">Fill out a simple form to reserve your spot.</p>
            ...
            <div className="md:hidden mt-4">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-[#3e64dd] mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="relative flex flex-col items-center text-center p-6">
            ...
            <p className="text-gray-600">We'll connect you with peers who truly understand your journey.</p>
            {/* Right arrow for desktop */}
            <div className="hidden md:block absolute right-0 top-1/3 transform translate-x-1/2">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-[#3e64dd]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
          ...
          <div className="relative flex flex-col items-center text-center p-6">
            ...
            <p className="text-gray-600">Spot early warning signs together and stay engaged.</p>
            {/* Right arrow for desktop */}
            <div className="hidden md:block absolute right-0 top-1/3 transform translate-x-1/2">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-[#3e64dd]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
          ...
          <div className="flex flex-col items-center text-center p-6">
            ...
            <h3 className="text-xl font-semibold mb-2 text-gray-800">Grow Stronger</h3>
            <p className="text-gray-600">Get real-time encouragement, stay supported, and build lasting recovery.</p>
          </div>
        </div>
      </div>
    </section>
