  ...
  const features = [
    {
      ...
      icon: <Brain className="h-10 w-10 text-[#3e64dd]" />
    },
    {
    ...
    },
    {
      ...
      icon: <ShieldCheck className="h-10 w-10 text-[#3e64dd]" />
    }
  ];
    ...
    <section className="mb-12">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
        {features.map((feature, index) => (
          <div 
            key={index} 
            className="bg-white p-6 rounded-lg shadow-md border-t-4 border-[#3e64dd] flex flex-col items-center text-center"
          >
            <div className="mb-4">
              {feature.icon}
            </div>
